  ...
  return (
    <div id='category' className='w-full bg-gray-100 lg:px-20 px-5 pt-[130px] pb-[80px] flex lg:flex-row flex-col justify-center items-center gap-20'>
      <div data-aos='zoom-in' data-aos-delay='50' className='lg:w-[15%] w-full flex flex-col justify-center lg:items-start items-center gap-[20px]'>
        <h1 className="text-purple-600 text-xl font-semibold text-center">Favorites item</h1>
        <h1 className="text-black font-semibold text-[42px] leading-[50px] lg:text-start text-center">Popular Category</h1>
        <button className='bg-purple-600 hover:bg-yellow-300 text-white hover:text-black px-8 py-3 rounded-lg font-semibold mt-[40px] mb-[40px]'>VIEW ALL</button>
      </div>
      ...
      <div className='lg:w-[85%]  w-full grid lg:grid-cols-5 grid-cols-1 justify-center items-start gap-10'>
        ...
        <div data-aos='zoom-in' data-aos-delay='100' className='flex flex-col justify-center items-center gap-6'>
          ...
          <h1 className='text-black text-xl font-semibold hover:text-purple-600 cursor-pointer'>Air Conditioners</h1>
        </div>
        <div data-aos='zoom-in' data-aos-delay='100' className='flex flex-col justify-center items-center gap-6'>
          <img src={cat3} alt="" className='rounded-full cursor-pointer' />
          <h1 className='text-black text-xl font-semibold hover:text-purple-600 cursor-pointer'>EV Charging Cables</h1>
        </div>
        <div data-aos='zoom-in' data-aos-delay='100' className='flex flex-col justify-center items-center gap-6'>
          <img src={cat4} alt="" className='rounded-full cursor-pointer' />
          <h1 className='text-black text-xl font-semibold hover:text-purple-600 cursor-pointer'>DVD Player slot</h1>
        </div>
        <div data-aos='zoom-in' data-aos-delay='100' className='flex flex-col justify-center items-center gap-6'>
          <img src={cat5} alt="" className='rounded-full cursor-pointer' />
          <h1 className='text-black text-xl font-semibold hover:text-purple-600 cursor-pointer'>360 Camera</h1>
        </div>
      </div>
